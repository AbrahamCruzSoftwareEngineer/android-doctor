...
class AndroidDoctorPlugin : Plugin<Project> {
    ...
    override fun apply(target: Project) {
        val doctorExtension = target.extensions.create(
            "androidDoctor",
        ...
        if (target == target.rootProject) {
            target.rootProject.allprojects { module ->
                ...
                if (doctorExtension.autoRunSampleApps.get() && isSampleModule) {
        ...
        target.afterEvaluate {
            ...
            if (analysisTask != null && collectTask != null) {
                if (doctorExtension.autoRunBuilds.get() || doctorExtension.autoRunTests.get() || doctorExtension.autoRunSampleApps.get()) {
